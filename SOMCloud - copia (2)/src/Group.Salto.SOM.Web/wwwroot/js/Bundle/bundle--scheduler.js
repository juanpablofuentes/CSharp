...
scheduler.form_blocks={
	...
	time:{
		render:function(sns) {
			...
			return "<div style='height:"+height+"px;padding-top:0px;font-size:inherit;' class='dhx_section_time'>"+html+"<span style='font-weight:normal; font-size:10pt;' class=\"clearfix\"> &nbsp;&ndash;&nbsp; </span>"+html+"</div>";
		},
		set_value:function(node,value,ev,config){
			var cfg = scheduler.config;
...
for(var r=n;r&&(!r.hasAttribute||!r.hasAttribute("date"));)r=r.parentNode;if(r){var o=this.templates.xml_date(r.getAttribute("date"));o.setDate(parseInt(n.innerHTML,10));var l=this.date.add(o,1,"day");!this.config.readonly&&this.config.dblclick_create&&this.addEventNow(o.valueOf(),l.valueOf(),a)}}};var a=e.changeEventId;e.changeEventId=function(){a.apply(this,arguments),t()&&this.year_view(!0)};var n=e.render_data,i=e.date.date_to_str("%Y/%m/%d"),r=e.date.str_to_date("%Y/%m/%d");e.render_data=function(e){
if(!t())return n.apply(this,arguments);for(var a=0;a<e.length;a++)this._year_render_event(e[a])};var o=e.clear_view;e.clear_view=function(){if(!t())return o.apply(this,arguments);var a=e._year_marked_cells,n=null;for(var i in a)a.hasOwnProperty(i)&&(n=a[i],n.className="dhx_month_head",n.removeAttribute("date"));e._year_marked_cells={}},e._hideToolTip=function(){this._tooltip&&(this._tooltip.style.display="none",this._tooltip.date=new Date(9999,1,1))},e._showToolTip=function(t,a,n,i){if(this._tooltip){
if(this._tooltip.date.valueOf()==t.valueOf())return;this._tooltip.innerHTML=""}else{var r=this._tooltip=document.createElement("div");r.className="dhx_year_tooltip",document.body.appendChild(r),r.onclick=e._click.dhx_cal_data}for(var o=this.getEvents(t,this.date.add(t,1,"day")),l="",d=0;d<o.length;d++){var s=o[d];if(this.filter_event(s.id,s)){var _=s.color?"background:"+s.color+";":"",c=s.textColor?"color:"+s.textColor+";":"";l+="<div class='dhx_tooltip_line' style='"+_+c+"' event_id='"+o[d].id+"'>",
l+="<div class='dhx_tooltip_date' style='"+_+c+"'>"+(o[d]._timed?this.templates.event_date(o[d].start_date):"")+"</div>",l+="<div class='dhx_event_icon icon_details'>&nbsp;</div>",l+=this.templates.year_tooltip(o[d].start_date,o[d].end_date,o[d])+"</div>"}}this._tooltip.style.display="",this._tooltip.style.top="0px",document.body.offsetWidth-a.left-this._tooltip.offsetWidth<0?this._tooltip.style.left=a.left-this._tooltip.offsetWidth+"px":this._tooltip.style.left=a.left+i.offsetWidth+"px",this._tooltip.date=t,
this._tooltip.innerHTML=l,document.body.offsetHeight-a.top-this._tooltip.offsetHeight<0?this._tooltip.style.top=a.top-this._tooltip.offsetHeight+i.offsetHeight+"px":this._tooltip.style.top=a.top+"px"},e._year_view_tooltip_handler=function(a){if(t()){var a=a||event,n=a.target||a.srcElement;"a"==n.tagName.toLowerCase()&&(n=n.parentNode),-1!=e._getClassName(n).indexOf("dhx_year_event")?e._showToolTip(r(n.getAttribute("date")),e.$domHelpers.getOffset(n),a,n):e._hideToolTip()}},e._init_year_tooltip=function(){
e._detachDomEvent(e._els.dhx_cal_data[0],"mouseover",e._year_view_tooltip_handler),dhtmlxEvent(e._els.dhx_cal_data[0],"mouseover",e._year_view_tooltip_handler)},e._get_year_cell=function(e){var t=e.getMonth()+12*(e.getFullYear()-this._min_date.getFullYear())-this.week_starts._month,a=this._els.dhx_cal_data[0].childNodes[t],n=this.week_starts[t]+e.getDate()-1,i=a.querySelectorAll(".dhx_year_body tr")[Math.floor(n/7)],r=i.querySelectorAll("td")[n%7];return r.querySelector(".dhx_month_head")},e._year_marked_cells={},
e._mark_year_date=function(t,a){var n=i(t),r=this._get_year_cell(t),o=this.templates.event_class(a.start_date,a.end_date,a);e._year_marked_cells[n]||(r.className="dhx_month_head dhx_year_event",r.setAttribute("date",n),e._year_marked_cells[n]=r),r.className+=o?" "+o:""},e._unmark_year_date=function(e){this._get_year_cell(e).className="dhx_month_head"},e._year_render_event=function(e){var t=e.start_date;for(t=t.valueOf()<this._min_date.valueOf()?this._min_date:this.date.date_part(new Date(t));t<e.end_date;)if(this._mark_year_date(t,e),
...
var t=[],a=this._els.dhx_cal_data[0],n=this.config;a.scrollTop=0,a.innerHTML="";var i=Math.floor(parseInt(a.style.width)/n.year_x),r=Math.floor((parseInt(a.style.height)-e.xy.year_top)/n.year_y);190>r&&(r=190,i=Math.floor((parseInt(a.style.width)-e.xy.scroll_width)/n.year_x));var o=i-11,l=0,d=document.createElement("div"),s=this.date.week_start(e._currentDate());this._process_ignores(s,7,"day",1);for(var _=7-(this._ignores_detected||0),c=0,u=0;7>u;u++)this._ignores&&this._ignores[u]||(this._cols[u]=Math.floor(o/(_-c)),
this._render_x_header(u,l,s,d),o-=this._cols[u],l+=this._cols[u],c++),s=this.date.add(s,1,"day");d.lastChild.className+=" dhx_scale_bar_last";for(var u=0;u<d.childNodes.length;u++)this._waiAria.yearHeadCell(d.childNodes[u]);for(var h=this.date[this._mode+"_start"](this.date.copy(this._date)),p=h,v=null,u=0;u<n.year_y;u++)for(var m=0;m<n.year_x;m++){v=document.createElement("div"),v.className="dhx_year_box",v.style.cssText="position:absolute;",v.setAttribute("date",this.templates.xml_format(h)),v.innerHTML="<div class='dhx_year_month'></div><div class='dhx_year_grid'><div class='dhx_year_week'>"+d.innerHTML+"</div><div class='dhx_year_body'></div></div>";
...
this.set_xy(v,i-10,r-E-10,i*m+5,r*u+5+e.xy.year_top),t[u*n.year_x+m]=(h.getDay()-(this.config.start_on_monday?1:0)+7)%7,h=this.date.add(h,1,"month")}this._els.dhx_cal_date[0].innerHTML=this.templates[this._mode+"_date"](p,h,this._mode),this.week_starts=t,t._month=p.getMonth(),this._min_date=p,this._max_date=h};var l=e.getActionData;e.getActionData=function(a){if(!t())return l.apply(e,arguments);var n=a?a.target:event.srcElement,i=e._get_year_month_date(n),r=e._get_year_month_cell(n),o=e._get_year_day_indexes(r);
return o&&i?(i=e.date.add(i,o.week,"week"),i=e.date.add(i,o.day,"day")):i=null,{date:i,section:null}},e._get_year_day_indexes=function(t){var a=e._get_year_el_node(t,this._locate_year_month_table);if(!a)return null;for(var n=0,i=0,n=0,r=a.rows.length;r>n;n++){for(var o=a.rows[n].getElementsByTagName("td"),i=0,l=o.length;l>i&&o[i]!=t;i++);if(l>i)break}return r>n?{day:i,week:n}:null},e._get_year_month_date=function(t){var t=e._get_year_el_node(t,e._locate_year_month_root);if(!t)return null;var a=t.getAttribute("date");
...
var n=e.form_blocks.recurring._get_node_value(t,a);return 1*n||0},_set_node_value:function(e,t,a){var n=e[t];if(n)if(n.name==t)n.value=a;else if(n.length)for(var i="object"==typeof a,r=0;r<n.length;r++)(i||n[r].value==a)&&(n[r].checked=i?!!a[n[r].value]:!!a)},_init_set_value:function(t,a,n){function i(e){for(var t=0;t<e.length;t++){var a=e[t];if(a.name)if(g[a.name])if(g[a.name].nodeType){var n=g[a.name];g[a.name]=[n,a]}else g[a.name].push(a);else g[a.name]=a}}function r(){b("dhx_repeat_day").style.display="none",
b("dhx_repeat_week").style.display="none",b("dhx_repeat_month").style.display="none",b("dhx_repeat_year").style.display="none",b("dhx_repeat_"+this.value).style.display="block",e.setLightboxSize()}function o(t){var a=[c(g,"repeat")];for(y[a[0]](a,t);a.length<5;)a.push("");var n="",i=d(g);if("no"==i)t.end=new Date(9999,1,1),n="no";else if("date_of_end"==i)t.end=p(c(g,"date_of_end"));else{e.transpose_type(a.join("_")),n=Math.max(1,c(g,"occurences_count"));var r=0;t.end=e.date.add(new Date(t.start),n+r,a.join("_"));
}return a.join("_")+"#"+n}function d(e){var t=e.end;if(t.length){for(var a=0;a<t.length;a++)if(t[a].checked)return t[a].value&&"on"!=t[a].value?t[a].value:a?2==a?"date_of_end":"occurences_count":"no"}else if(t.value)return t.value;return"no"}function l(e,t){var a=e.end;if(a.length){var n=!!a[0].value&&"on"!=a[0].value;if(n)for(var i=0;i<a.length;i++)a[i].value==t&&(a[i].checked=!0);else{var r=0;switch(t){case"no":r=0;break;case"date_of_end":r=2;break;default:r=1}a[r].checked=!0}}else a.value=t}function s(t,a){
var n=e.form_blocks.recurring._set_node_value,i=t.split("#");switch(t=i[0].split("_"),x[t[0]](t,a),i[1]){case"no":l(g,"no");break;case"":l(g,"date_of_end");var r=a.end;e.config.include_end_by&&(r=e.date.add(r,-1,"day")),n(g,"date_of_end",v(r));break;default:l(g,"occurences_count"),n(g,"occurences_count",i[1])}n(g,"repeat",t[0]);var o=e.form_blocks.recurring._get_form_node(g,"repeat",t[0]);"SELECT"==o.nodeName&&o.onchange?o.onchange():o.onclick&&o.onclick()}var _=e.form_blocks.recurring,c=_._get_node_value,u=_._set_node_value;
e.form_blocks.recurring._ds={start:n.start_date,end:n._end_date};var h=e.date.str_to_date(e.config.repeat_date),p=function(t){var a=h(t);return e.config.include_end_by&&(a=e.date.add(a,1,"day")),a},v=e.date.date_to_str(e.config.repeat_date),m=t.getElementsByTagName("FORM")[0],g={};if(i(m.getElementsByTagName("INPUT")),i(m.getElementsByTagName("SELECT")),!e.config.repeat_date_of_end){var f=e.date.date_to_str(e.config.repeat_date);e.config.repeat_date_of_end=f(e.date.add(e._currentDate(),30,"day"));
}u(g,"date_of_end",e.config.repeat_date_of_end);var b=function(e){return document.getElementById(e)||{style:{}}};e.form_blocks.recurring._get_repeat_code=o;var y={month:function(t,a){var n=e.form_blocks.recurring._get_node_value,i=e.form_blocks.recurring._get_node_numeric_value;"d"==n(g,"month_type")?(t.push(Math.max(1,i(g,"month_count"))),a.start.setDate(n(g,"month_day"))):(t.push(Math.max(1,i(g,"month_count2"))),t.push(n(g,"month_day2")),t.push(Math.max(1,i(g,"month_week2"))),e.config.repeat_precise||a.start.setDate(1)),
a._start=!0},week:function(t,a){var n=e.form_blocks.recurring._get_node_value,i=e.form_blocks.recurring._get_node_numeric_value;t.push(Math.max(1,i(g,"week_count"))),t.push(""),t.push("");for(var r=[],o=n(g,"week_day",!0),d=a.start.getDay(),l=!1,s=0;s<o.length;s++)r.push(o[s]),l=l||o[s]==d;r.length||(r.push(d),l=!0),r.sort(),e.config.repeat_precise?l||(e.transpose_day_week(a.start,r,1,7),a._start=!0):(a.start=e.date.week_start(a.start),a._start=!0),t.push(r.join(","))},day:function(t){var a=e.form_blocks.recurring._get_node_value,n=e.form_blocks.recurring._get_node_numeric_value;
"d"==a(g,"day_type")?t.push(Math.max(1,n(g,"day_count"))):(t.push("week"),t.push(1),t.push(""),t.push(""),t.push(e.config.recurring_workdays.join(",")),t.splice(0,1))},year:function(t,a){var n=e.form_blocks.recurring._get_node_value;"d"==n(g,"year_type")?(t.push("1"),a.start.setMonth(0),a.start.setDate(n(g,"year_day")),a.start.setMonth(n(g,"year_month"))):(t.push("1"),t.push(n(g,"year_day2")),t.push(n(g,"year_week2")),a.start.setDate(1),a.start.setMonth(n(g,"year_month2"))),a._start=!0}},x={week:function(t,a){
var n=e.form_blocks.recurring._set_node_value;n(g,"week_count",t[1]);for(var i=t[4].split(","),r={},o=0;o<i.length;o++)r[i[o]]=!0;n(g,"week_day",r)},month:function(t,a){var n=e.form_blocks.recurring._set_node_value;""===t[2]?(n(g,"month_type","d"),n(g,"month_count",t[1]),n(g,"month_day",a.start.getDate())):(n(g,"month_type","w"),n(g,"month_count2",t[1]),n(g,"month_week2",t[3]),n(g,"month_day2",t[2]))},day:function(t,a){var n=e.form_blocks.recurring._set_node_value;n(g,"day_type","d"),n(g,"day_count",t[1]);
},year:function(t,a){var n=e.form_blocks.recurring._set_node_value;""===t[2]?(n(g,"year_type","d"),n(g,"year_day",a.start.getDate()),n(g,"year_month",a.start.getMonth())):(n(g,"year_type","w"),n(g,"year_week2",t[3]),n(g,"year_day2",t[2]),n(g,"year_month2",a.start.getMonth()))}};e.form_blocks.recurring._set_repeat_code=s;for(var k=0;k<m.elements.length;k++){var w=m.elements[k];switch(w.name){case"repeat":"SELECT"==w.nodeName?w.onchange=r:w.onclick=r}}e._lightbox._rec_init_done=!0},set_value:function(t,a,n){
var i=e.form_blocks.recurring;e._lightbox._rec_init_done||i._init_set_value(t,a,n),t.open=!n.rec_type,t.blocked=this._is_modified_occurence(n);var r=i._ds;r.start=n.start_date,r.end=n._end_date,i._toggle_block(),a&&i._set_repeat_code(a,r)},get_value:function(t,a){if(t.open){var n=e.form_blocks.recurring._ds,i={};this.formSection("time").getValue(i),n.start=i.start_date,a.rec_type=e.form_blocks.recurring._get_repeat_code(n),n._start?(a.start_date=new Date(n.start),a._start_date=new Date(n.start),n._start=!1):a._start_date=null,
a._end_date=n.end,a.rec_pattern=a.rec_type.split("#")[0]}else a.rec_type=a.rec_pattern="",a._end_date=a.end_date;return a.rec_type},_get_button:function(){var t=e.formSection("recurring").header;return t.firstChild.firstChild},_get_form:function(){return e.formSection("recurring").node},open:function(){var t=e.form_blocks.recurring,a=t._get_form();a.open||t._toggle_block()},close:function(){var t=e.form_blocks.recurring,a=t._get_form();a.open&&t._toggle_block()},_toggle_block:function(){var t=e.form_blocks.recurring,a=t._get_form(),n=t._get_button();
a.open||a.blocked?(a.style.height="0px",n&&(n.style.backgroundPosition="-5px 20px",n.nextSibling.innerHTML=e.locale.labels.button_recurring)):(a.style.height="auto",n&&(n.style.backgroundPosition="-5px 0px",n.nextSibling.innerHTML=e.locale.labels.button_recurring_open)),a.open=!a.open,e.setLightboxSize()},focus:function(e){},button_click:function(t,a,n,i){var r=e.form_blocks.recurring,i=r._get_form();i.blocked||e.form_blocks.recurring._toggle_block()}},e._rec_markers={},e._rec_markers_pull={},e._add_rec_marker=function(e,t){
e._pid_time=t,this._rec_markers[e.id]=e,this._rec_markers_pull[e.event_pid]||(this._rec_markers_pull[e.event_pid]={}),this._rec_markers_pull[e.event_pid][t]=e},e._get_rec_marker=function(e,t){var a=this._rec_markers_pull[t];return a?a[e]:null},e._get_rec_markers=function(e){return this._rec_markers_pull[e]||[]},e._rec_temp=[],function(){var t=e.addEvent;e.addEvent=function(a,n,i,r,o){var d=t.apply(this,arguments);if(d&&e.getEvent(d)){var l=e.getEvent(d);this._is_modified_occurence(l)&&e._add_rec_marker(l,1e3*l.event_length),
l.rec_type&&(l.rec_pattern=l.rec_type.split("#")[0])}return d}}(),e.attachEvent("onEventIdChange",function(t,a){if(!this._ignore_call){this._ignore_call=!0,e._rec_markers[t]&&(e._rec_markers[a]=e._rec_markers[t],delete e._rec_markers[t]),e._rec_markers_pull[t]&&(e._rec_markers_pull[a]=e._rec_markers_pull[t],delete e._rec_markers_pull[t]);for(var n=0;n<this._rec_temp.length;n++){var i=this._rec_temp[n];i.event_pid==t&&(i.event_pid=a,this.changeEventId(i.id,a+"#"+i.id.split("#")[1]))}for(var n in this._rec_markers){
var i=this._rec_markers[n];i.event_pid==t&&(i.event_pid=a,i._pid_changed=!0)}var r=e._rec_markers[a];r&&r._pid_changed&&(delete r._pid_changed,setTimeout(function(){e.callEvent("onEventChanged",[a,e.getEvent(a)])},1)),delete this._ignore_call}}),e.attachEvent("onConfirmedBeforeEventDelete",function(e){var t=this.getEvent(e);if(this._is_virtual_event(e)||this._is_modified_occurence(t)&&t.rec_type&&"none"!=t.rec_type){e=e.split("#");var a=this.uid(),n=e[1]?e[1]:t._pid_time/1e3,i=this._copy_event(t);
i.id=a,i.event_pid=t.event_pid||e[0];var r=n;i.event_length=r,i.rec_type=i.rec_pattern="none",this.addEvent(i),this._add_rec_marker(i,1e3*r)}else{t.rec_type&&this._lightbox_id&&this._roll_back_dates(t);var o=this._get_rec_markers(e);for(var d in o)o.hasOwnProperty(d)&&(e=o[d].id,this.getEvent(e)&&this.deleteEvent(e,!0))}return!0}),e.attachEvent("onEventDeleted",function(t,a){!this._is_virtual_event(t)&&this._is_modified_occurence(a)&&(e._events[t]||(a.rec_type=a.rec_pattern="none",this.setEvent(t,a)));
}),e.attachEvent("onEventChanged",function(e,t){if(this._loading)return!0;var a=this.getEvent(e);if(this._is_virtual_event(e)){var e=e.split("#"),n=this.uid();this._not_render=!0;var i=this._copy_event(t);i.id=n,i.event_pid=e[0];var r=e[1];i.event_length=r,i.rec_type=i.rec_pattern="",this._add_rec_marker(i,1e3*r),this.addEvent(i),this._not_render=!1}else{a.rec_type&&this._lightbox_id&&this._roll_back_dates(a);var o=this._get_rec_markers(e);for(var d in o)o.hasOwnProperty(d)&&(delete this._rec_markers[o[d].id],
this.deleteEvent(o[d].id,!0));delete this._rec_markers_pull[e];for(var l=!1,s=0;s<this._rendered.length;s++)this._rendered[s].getAttribute("event_id")==e&&(l=!0);l||(this._select_id=null)}return!0}),e.attachEvent("onEventAdded",function(e){if(!this._loading){var t=this.getEvent(e);t.rec_type&&!t.event_length&&this._roll_back_dates(t)}return!0}),e.attachEvent("onEventSave",function(e,t,a){var n=this.getEvent(e);return n.rec_type||!t.rec_type||this._is_virtual_event(e)||(this._select_id=null),!0}),
...
e.start_date.setFullYear(e._start_date.getFullYear()))},e._is_virtual_event=function(e){return-1!=e.toString().indexOf("#")},e._is_modified_occurence=function(e){return e.event_pid&&"0"!=e.event_pid},e._validId=function(e){return!this._is_virtual_event(e)},e.showLightbox_rec=e.showLightbox,e.showLightbox=function(t){var a=this.locale,n=e.config.lightbox_recurring,i=this.getEvent(t),r=i.event_pid,o=this._is_virtual_event(t);o&&(r=t.split("#")[0]);var d=function(t){var a=e.getEvent(t);return a._end_date=a.end_date,
a.end_date=new Date(a.start_date.valueOf()+1e3*a.event_length),e.showLightbox_rec(t)};if((r||1*r===0)&&i.rec_type)return d(t);if(!r||"0"===r||!a.labels.confirm_recurring||"instance"==n||"series"==n&&!o)return this.showLightbox_rec(t);if("ask"==n){var l=this;dhtmlx.modalbox({text:a.labels.confirm_recurring,title:a.labels.title_confirm_recurring,width:"500px",position:"middle",buttons:[a.labels.button_edit_series,a.labels.button_edit_occurrence,a.labels.icon_cancel],callback:function(e){switch(+e){
case 0:return d(r);case 1:return l.showLightbox_rec(t);case 2:return}}})}else d(r)},e.get_visible_events_rec=e.get_visible_events,e.get_visible_events=function(e){for(var t=0;t<this._rec_temp.length;t++)delete this._events[this._rec_temp[t].id];this._rec_temp=[];for(var a=this.get_visible_events_rec(e),n=[],t=0;t<a.length;t++)a[t].rec_type?"none"!=a[t].rec_pattern&&this.repeat_date(a[t],n):n.push(a[t]);return n},function(){var t=e.isOneDayEvent;e.isOneDayEvent=function(e){return e.rec_type?!0:t.call(this,e);
};var a=e.updateEvent;e.updateEvent=function(t){var n=e.getEvent(t);n&&n.rec_type&&(n.rec_pattern=(n.rec_type||"").split("#")[0]),n&&n.rec_type&&!this._is_virtual_event(t)?e.update_view():a.call(this,t)}}(),e.transponse_size={day:1,week:7,month:1,year:12},e.date.day_week=function(e,t,a){e.setDate(1),a=7*(a-1);var n=e.getDay(),i=1*t+a-n+1;e.setDate(a>=i?i+7:i)},e.transpose_day_week=function(t,a,n,i,r){for(var o=(t.getDay()||(e.config.start_on_monday?7:0))-n,d=0;d<a.length;d++)if(a[d]>o)return t.setDate(t.getDate()+1*a[d]-o-(i?n:r));
this.transpose_day_week(t,a,n+i,null,n)},e.transpose_type=function(t){var a="transpose_"+t;if(!this.date[a]){var n=t.split("_"),i=864e5,r="add_"+t,o=this.transponse_size[n[0]]*n[1];if("day"==n[0]||"week"==n[0]){var d=null;if(n[4]&&(d=n[4].split(","),e.config.start_on_monday)){for(var l=0;l<d.length;l++)d[l]=1*d[l]||7;d.sort()}this.date[a]=function(t,a){var n=Math.floor((a.valueOf()-t.valueOf())/(i*o));n>0&&t.setDate(t.getDate()+n*o),d&&e.transpose_day_week(t,d,1,o)},this.date[r]=function(t,a){var n=new Date(t.valueOf());
if(d)for(var i=0;a>i;i++)e.transpose_day_week(n,d,0,o);else n.setDate(n.getDate()+a*o);return n}}else("month"==n[0]||"year"==n[0])&&(this.date[a]=function(t,a){var i=Math.ceil((12*a.getFullYear()+1*a.getMonth()+1-(12*t.getFullYear()+1*t.getMonth()+1))/o-1);i>=0&&t.setMonth(t.getMonth()+i*o),n[3]&&e.date.day_week(t,n[2],n[3])},this.date[r]=function(t,a){var i=new Date(t.valueOf());return i.setMonth(i.getMonth()+a*o),n[3]&&e.date.day_week(i,n[2],n[3]),i})}},e.repeat_date=function(t,a,n,i,r,o){i=i||this._min_date,
r=r||this._max_date;var d=o||-1,l=new Date(t.start_date.valueOf()),s=l.getHours(),_=0;for(!t.rec_pattern&&t.rec_type&&(t.rec_pattern=t.rec_type.split("#")[0]),this.transpose_type(t.rec_pattern),e.date["transpose_"+t.rec_pattern](l,i);l<t.start_date||e._fix_daylight_saving_date(l,i,t,l,new Date(l.valueOf()+1e3*t.event_length)).valueOf()<=i.valueOf()||l.valueOf()+1e3*t.event_length<=i.valueOf();)l=this.date.add(l,1,t.rec_pattern);for(;r>l&&l<t.end_date&&(0>d||d>_);){l.setHours(s);var c=e.config.occurrence_timestamp_in_utc?Date.UTC(l.getFullYear(),l.getMonth(),l.getDate(),l.getHours(),l.getMinutes(),l.getSeconds()):l.valueOf(),u=this._get_rec_marker(c,t.id);
if(u)n&&("none"!=u.rec_type&&_++,a.push(u));else{var h=new Date(l.valueOf()+1e3*t.event_length),p=this._copy_event(t);if(p.text=t.text,p.start_date=l,p.event_pid=t.id,p.id=t.id+"#"+Math.ceil(c/1e3),p.end_date=h,p.end_date=e._fix_daylight_saving_date(p.start_date,p.end_date,t,l,p.end_date),p._timed=this.isOneDayEvent(p),!p._timed&&!this._table_view&&!this.config.multi_day)return;a.push(p),n||(this._events[p.id]=p,this._rec_temp.push(p)),_++}l=this.date.add(l,1,t.rec_pattern)}},e._fix_daylight_saving_date=function(e,t,a,n,i){
