...
{
    public class WOStatusPostconditionQueryResult : IWOStatusPostconditionQueryResult
    {
        private IWorkOrderStatusService _workOrderStatusService;

        public WOStatusPostconditionQueryResult(IWorkOrderStatusService workOrderStatusService)
        {
