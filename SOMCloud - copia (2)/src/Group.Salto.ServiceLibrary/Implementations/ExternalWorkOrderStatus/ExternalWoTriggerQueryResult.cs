...
{
    public class ExternalWoTriggerQueryResult : IExternalWoTriggerQueryResult
    {
        private IExternalWorkOrderStatusService _externalWorkOrderStatusService;

        public ExternalWoTriggerQueryResult(IExternalWorkOrderStatusService externalWorkOrderStatusService)
        {
