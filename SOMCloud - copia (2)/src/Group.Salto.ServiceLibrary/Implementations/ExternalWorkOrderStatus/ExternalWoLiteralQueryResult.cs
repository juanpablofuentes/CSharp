...
{
    public class ExternalWoLiteralQueryResult : IExternalWoLiteralQueryResult
    {
        private IExternalWorkOrderStatusService _externalWorkOrderStatusService;

        public ExternalWoLiteralQueryResult(IExternalWorkOrderStatusService externalWorkOrderStatusService)
        {
