...
{
    public class ProjectQueryFactory : IProjectQueryFactory
    {
        private IDictionary<QueryTypeEnum, Func<IQueryResult>> _servicesQuery;
        private readonly IServiceProvider _services;

        public ProjectQueryFactory(IServiceProvider services)
        {
            ...
            _servicesQuery.Add(QueryTypeEnum.Autocomplete, () => _services.GetService<IProjectAutocompleteQueryResult>());
        }
