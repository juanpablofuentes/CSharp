...
{
    public class AssetStatusesQueryFactory : IAssetStatusesQueryFactory
    {
        private IDictionary<QueryTypeEnum, Func<IQueryResult>> _servicesQuery;
        private readonly IServiceProvider _services;

        public AssetStatusesQueryFactory(IServiceProvider services)
        {
            ...
            _servicesQuery.Add(QueryTypeEnum.Autocomplete, () => _services.GetService<IAssetStatusesAutocompleteQueryResult>());
        }
