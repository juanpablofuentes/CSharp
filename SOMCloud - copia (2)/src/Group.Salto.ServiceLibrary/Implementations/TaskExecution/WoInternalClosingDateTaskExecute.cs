...
{
    public class WoInternalClosingDateTaskExecute : IWoInternalClosingDateTaskExecute
    {
        public ResultDto<bool> PerformTask(TaskExecutionValues taskExecutionValues)
        {
            taskExecutionValues.CurrentWorkOrder.InternalClosingTime = taskExecutionValues.TaskParameters.Date;
