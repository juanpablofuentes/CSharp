...
{
    public class PeopleTechnicianLiteralQueryResult : IPeopleTechnicianLiteralQueryResult
    {
        private IPeopleService _peopleService;

        public PeopleTechnicianLiteralQueryResult(IPeopleService peopleService)
        {
