...
namespace Group.Salto.DataAccess.Migrations
{
    ...
    [Migration("20190613103658_BillStatus_Table")]
    partial class BillStatus_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Group.Salto.Entities.ActionGroups", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Group.Salto.Entities.BillStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Group.Salto.Entities.CalculationType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Group.Salto.Entities.DamagedEquipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("DamagedEquipment");
                });

            modelBuilder.Entity("Group.Salto.Entities.DaysType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Group.Salto.Entities.ExpenseTicketStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Group.Salto.Entities.ExtraFieldTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<bool>("AllowedValuesVisibility");

                    b.Property<bool>("ErpSystemVisibility");

                    b.Property<bool>("IsMandatoryVisibility");

                    b.Property<bool>("MultipleChoiceVisibility");
            ...
            modelBuilder.Entity("Group.Salto.Entities.ItemTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Group.Salto.Entities.ModuleActionGroups", b =>
                {
                    b.Property<Guid>("ModuleId");

                    b.Property<Guid>("ActionGroupsId");

                    b.HasKey("ModuleId", "ActionGroupsId");

                    b.HasIndex("ActionGroupsId");

                    b.ToTable("ModuleActionGroups");
                });
            ...
            modelBuilder.Entity("Group.Salto.Entities.PostconditionTypes", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("PostconditionTypes");
                });

            modelBuilder.Entity("Group.Salto.Entities.PreconditionTypes", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Group.Salto.Entities.ReferenceTimeSla", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Group.Salto.Entities.RolesActionGroupsActions", b =>
                {
                    ...
                    b.HasKey("RolId", "ActionGroupId", "ActionId");

                    b.HasIndex("ActionGroupId");

                    b.HasIndex("ActionId");

                    b.ToTable("RolesActionGroupsActions");
                });
            ...
            modelBuilder.Entity("Group.Salto.Entities.TriggerTypes", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Group.Salto.Entities.WarehouseMovementTypes", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("WarehouseMovementTypes");
                });

            modelBuilder.Entity("Group.Salto.Entities.WorkForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Group.Salto.Entities.WorkOrderColumns", b =>
                {
                    b.Property<int>("Id")
                    ...
                    b.ToTable("WorkOrderColumns");
                });

            modelBuilder.Entity("Group.Salto.Entities.WorkOrderDefaultColumns", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("WorkOrderColumnId");

                    b.HasKey("Id");

                    b.HasIndex("WorkOrderColumnId");

                    b.ToTable("WorkOrderDefaultColumns");
                });
            ...
            modelBuilder.Entity("Group.Salto.Entities.ModuleActionGroups", b =>
                {
                    b.HasOne("Group.Salto.Entities.ActionGroups", "ActionGroups")
                        .WithMany("ModuleActionGroups")
                        .HasForeignKey("ActionGroupsId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Group.Salto.Entities.RolesActionGroupsActions", b =>
                {
                    b.HasOne("Group.Salto.Entities.ActionGroups", "ActionGroups")
                        .WithMany("RolesActionGroupsActions")
            ...
            modelBuilder.Entity("Group.Salto.Entities.WorkOrderDefaultColumns", b =>
                {
                    b.HasOne("Group.Salto.Entities.WorkOrderColumns", "WorkOrderColumns")
                        .WithMany("WorkOrderDefaultColumns")
                        .HasForeignKey("WorkOrderColumnId")
