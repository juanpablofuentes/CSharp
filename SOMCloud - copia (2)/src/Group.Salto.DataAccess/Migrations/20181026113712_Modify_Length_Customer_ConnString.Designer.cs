...
namespace Group.Salto.DataAccess.Migrations
{
    ...
    [Migration("20181026113712_Modify_Length_Customer_ConnString")]
    partial class Modify_Length_Customer_ConnString
    {
            ...
            modelBuilder.Entity("Group.Salto.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CultureCode = "es", Name = "Spanish", UpdateDate = new DateTime(2018, 10, 26, 11, 37, 12, 38, DateTimeKind.Utc) },
                        new { Id = 2, CultureCode = "ca", Name = "Catalan", UpdateDate = new DateTime(2018, 10, 26, 11, 37, 12, 38, DateTimeKind.Utc) },
                        new { Id = 3, CultureCode = "en", Name = "English", UpdateDate = new DateTime(2018, 10, 26, 11, 37, 12, 38, DateTimeKind.Utc) }
                    );
                });
