...
namespace Group.Salto.DataAccess.Migrations
{
    ...
    [Migration("20181018132039_InitialCreate")]
            ...
            modelBuilder.Entity("Group.Salto.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CultureCode = "es", Name = "Spanish", UpdateDate = new DateTime(2018, 10, 18, 13, 20, 38, 818, DateTimeKind.Utc) },
                        new { Id = 2, CultureCode = "ca", Name = "Catalan", UpdateDate = new DateTime(2018, 10, 18, 13, 20, 38, 818, DateTimeKind.Utc) },
                        new { Id = 3, CultureCode = "en", Name = "English", UpdateDate = new DateTime(2018, 10, 18, 13, 20, 38, 818, DateTimeKind.Utc) }
                    );
                });
