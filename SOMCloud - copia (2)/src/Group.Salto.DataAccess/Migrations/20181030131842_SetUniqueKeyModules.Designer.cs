...
namespace Group.Salto.DataAccess.Migrations
{
    ...
    [Migration("20181030131842_SetUniqueKeyModules")]
    partial class SetUniqueKeyModules
    {
            ...
            modelBuilder.Entity("Group.Salto.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CultureCode = "es", Name = "Spanish", UpdateDate = new DateTime(2018, 10, 30, 13, 18, 41, 250, DateTimeKind.Utc) },
                        new { Id = 2, CultureCode = "ca", Name = "Catalan", UpdateDate = new DateTime(2018, 10, 30, 13, 18, 41, 250, DateTimeKind.Utc) },
                        new { Id = 3, CultureCode = "en", Name = "English", UpdateDate = new DateTime(2018, 10, 30, 13, 18, 41, 250, DateTimeKind.Utc) }
                    );
                });
